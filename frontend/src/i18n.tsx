...
const messages = {
  "zh-CN": {
    ...
    settingsBtn: "设置",
    testConn: "测试连接",
    tasks: "任务", topics: "课题", runs: "运行记录", toggleSidebar: "切换侧栏",
    clearTasks: "清除任务",
  ...
  en: {
    ...
    tasks: "Tasks", topics: "Topics", runs: "Runs", toggleSidebar: "Toggle sidebar",
  ...
  de: {
    ...
    tasks: "Aufgaben", topics: "Themen", runs: "Läufe", toggleSidebar: "Seitenleiste umschalten",
