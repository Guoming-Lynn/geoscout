...
const messages = {
  "zh-CN": {
    ...
    checking: "正在检查本机连接…",
    apiUnreachable: "连不上本机 API。请先运行 GEOScout.bat，再重试。",
    retry: "重试连接",
    apiTimeout: "本机 API 没有响应。请先运行 GEOScout.bat，再重试。",
    prevPage: "上一页",
    nextPage: "下一页",
    pageStatus: "第 {from}–{to} 条，共 {total} 条",
    samplePreview: "这里只显示前 {shown} 个样本，共 {total} 个。完整列表在 Excel 里。",
    parseHint: "当前条件来自规则解析。点「解析条件」后，模型会再核对组织、测序类型和分组。",
    donorUpperBound: "至多 {n}（BioSample，未去重）",
    matrixFiles: "补充文件",
    matrix_filename_only: "文件名像处理后矩阵，尚未打开核对",
    matrix_raw_archive: "只有 RAW 压缩包，没有处理后矩阵文件名",
    matrix_not_listed: "补充目录里没有矩阵或 RAW 文件名",
    matrix_unchecked: "补充目录没有列出来",
    ...
    settingsBtn: "设置",
    testConn: "测试连接",
    tasks: "任务", topics: "课题", runs: "运行记录", toggleSidebar: "切换侧栏", close: "关闭",
    clearTasks: "清除任务",
  ...
  en: {
    ...
    apiUnreachable: "Local API is unreachable. Start GEOScout.bat, then retry.",
    retry: "Retry connection",
    apiTimeout: "Local API did not respond. Start GEOScout.bat, then retry.",
    prevPage: "Previous page",
    nextPage: "Next page",
    pageStatus: "{from}–{to} of {total}",
    samplePreview: "Showing the first {shown} of {total} samples. The full list is in the Excel export.",
    parseHint: "These criteria come from the rule parser. Use Parse criteria for a model check of tissue, assay, and groups.",
    donorUpperBound: "at most {n} (BioSample, not deduplicated)",
    matrixFiles: "Supplementary files",
    matrix_filename_only: "Filename looks like a processed matrix; the file was not opened",
    matrix_raw_archive: "RAW archive only; no processed-matrix filename",
    matrix_not_listed: "No matrix or RAW filename in the supplement listing",
    matrix_unchecked: "Supplement directory was not listed",
    ...
    tasks: "Tasks", topics: "Topics", runs: "Runs", toggleSidebar: "Toggle sidebar", close: "Close",
  ...
  de: {
    ...
    apiUnreachable: "Lokale API nicht erreichbar. GEOScout.bat starten und erneut versuchen.",
    retry: "Verbindung erneut versuchen",
    apiTimeout: "Lokale API hat nicht geantwortet. GEOScout.bat starten und erneut versuchen.",
    prevPage: "Vorherige Seite",
    nextPage: "Nächste Seite",
    pageStatus: "{from}–{to} von {total}",
    samplePreview: "Die ersten {shown} von {total} Proben. Die vollständige Liste steht in der Excel-Datei.",
    parseHint: "Diese Kriterien kommen vom Regelparser. Mit „Kriterien parsen“ prüft das Modell Gewebe, Assay und Gruppen.",
    donorUpperBound: "höchstens {n} (BioSample, nicht dedupliziert)",
    matrixFiles: "Zusatzdateien",
    matrix_filename_only: "Dateiname sieht nach einer Matrix aus; die Datei wurde nicht geöffnet",
    matrix_raw_archive: "Nur RAW-Archiv, kein Matrix-Dateiname",
    matrix_not_listed: "Kein Matrix- oder RAW-Dateiname im Zusatzverzeichnis",
    matrix_unchecked: "Zusatzverzeichnis wurde nicht gelesen",
    ...
    tasks: "Aufgaben", topics: "Themen", runs: "Läufe", toggleSidebar: "Seitenleiste umschalten", close: "Schließen",
